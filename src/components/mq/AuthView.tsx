...
import { Music, Mail, Eye, EyeOff, Loader2, ArrowLeft } from "lucide-react";
...
export default function AuthView() {
  ...
  const handleDemoLogin = () => {
    // Quick demo login without server for testing
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "var(--mq-gradient)" }}
      />
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  <label className="text-sm mb-1 block" style={{ color: "var(--mq-text-muted)" }}>
                    Email
                  </label>
                ...
                <div className="relative my-4">
                  ...
                  <div className="relative flex justify-center">
                    <span className="px-3 text-xs" style={{ backgroundColor: "var(--mq-card)", color: "var(--mq-text-muted)" }}>
                      или
                    </span>
                  </div>
                </div>
                ...
                <p className="text-center text-sm" style={{ color: "var(--mq-text-muted)" }}>
                  Нет аккаунта?{" "}
                  <button
                    onClick={() => { setAuthStep("register"); setError(""); }}
        ...
        {authStep === "confirm" && (
          ...
          >
            ...
            >
              ...
              <h2 className="text-xl font-semibold mb-2" style={{ color: "var(--mq-text)" }}>
                Подтвердите почту
              </h2>
